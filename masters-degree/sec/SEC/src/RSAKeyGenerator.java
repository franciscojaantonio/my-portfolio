...
public class RSAKeyGenerator {
    ...
    public RSAKeyGenerator(String mode, String privkeyPath, String pubkeyPath) {
        this.mode = mode;
    ...
    public void run() throws Exception {
        ...
        // check args
        if (mode == null || privkeyPath == null || pubkeyPath == null || mode.length() < 1 || privkeyPath.length() < 1 || pubkeyPath.length() < 1) {
